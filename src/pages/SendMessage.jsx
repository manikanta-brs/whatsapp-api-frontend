...
//                 params[i + 1] = ""; // Use position as key (1-based index)
//               }
//             }
//           }
//         }
...
//         if (selectedTemplateData.parameter_format === "NAMED") {
//           components[0].parameters = Object.entries(templateParams).map(
//             ([key, value]) => ({
//               type: "text",
//               text: value,
//             })
...
//     return {
//       background: "white",
//       borderRadius: platform === "android" ? "10px" : "20px", // Different screen corner radiuses
//       overflow: "hidden",
...
//               className="border border-gray-300 p-2 rounded text-gray-700 w-full" // Expanded width
//             >
...
//                 {" "}
//                 {/* Added overflow-y-auto */}
//                 <div className="bg-white rounded-lg p-4 shadow-sm text-gray-800">
//                   <p>{previewMessage}</p>
//                 </div>
...
const SendMessageForm = ({ selectedCategory }) => {
  // Receive selectedCategory as a prop
  const [formData, setFormData] = useState({
    messaging_product: "whatsapp",
    to: "",
    type: "text",
  ...
  const {
    ...
    isTemplatesLoading,
    isTemplatesError,
  } = useGetTemplatesQuery(selectedCategory); // Pass the selected category
